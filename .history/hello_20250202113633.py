...
Please provide a workout plan that follows the JSON schema exactly as shown below.
...
Using the above schema, please generate a 7-day or 1-day or 5-days so on workout plan.{question}
"""

prompt = PromptTemplate(input_variables=["question"], template=template)

formatted_prompt = prompt.format(question="""please give me the 2 days workout schedule in jason form """)
